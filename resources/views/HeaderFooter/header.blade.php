<div class=" style="height:88px;">
    <!-- component -->	<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        <a class="my-1 text-sm md:mx-4 md:my-0" href="#"><img class="object-cover h-5 w-5 flex space-x-5" src="{{ asset('icones/heart.png') }}" alt="Favoris"></a>
        <a class="my-1 text-sm md:mx-4 md:my-0" href="#"><img class="object-cover h-5 w-5 flex space-x-5" src="{{ asset('icones/panier.png') }}" alt="Panier"></a>
      ...
      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
        ...
        <ul class="py-2" aria-labelledby="user-menu-button">
          ...
          <li>
            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Commandes</a>
          </li>
          <li>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
                            <div class="flex flex-col">
                                ...
                                <ul class="mt-4 text-[15px] space-y-3">
                                    <li>
                                        <a href="/sneakersHautes" class="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group gap-2">
                                    ...
                                    <li>
                                        <a href="/sneakersBasses" class="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group gap-2">
