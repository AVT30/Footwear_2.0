                ...
                @foreach ($chaussures as $chaussure)
                    @if ($chaussure->pourcentage)
                        <div class="relative mx-auto w-80">
                            <a href="{{ route('chaussures.modifier', $chaussure->id_chaussure) }}"
                                ...
                                <div class=" p-4  bg-white shadow w-80">
                                    <div class="flex justify-center relative rounded-lg overflow-hidden h-96 w-72">
                                        ...
                                        <div class="absolute flex flex-col top-0 right-0 p-3">
                                            <a
                                                class=" opacity-70 bg-white hover:opacity-100  hover:text-purple-500 shadow hover:shadow-md text-gray-500 rounded-full w-8 h-8 text-center p-1"><svg
                                    ...
                                    <div class="grid grid-cols-1">
                                        <div class="flex items-center justify-start">
                                            <p
                                                ...
                                                @if ($chaussure->pourcentage)
                                                    <span class="text-lg text-red-600">{{ $chaussure->prix }} CHF <span
                                                            class="line-through text-gray-500 ">{{ $chaussure->prix / (1 - $chaussure->pourcentage / 100) }}
                                                            CHF</span></span>
                                                @else
