...
<div class="relative z-10 py-10 ">
    ...
    <div class="z-0 absolute bottom-0 left-0 right-0 flex justify-center space-x-2 pb-2 ">
      <button id="prev2" class="p-2 rounded-full hover:bg-gray-300 focus:outline-none focus:bg-gray-300 hidden md:block">
      ...
      <button id="next2" class="p-2 rounded-full hover:bg-gray-300 focus:outline-none focus:bg-gray-300 hidden md:block">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4">
