...
@section('content')
    <div class="p-10 grid grid-cols-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-5">
        ...
        <div
            ...
            @if ($chaussuresPagineesParType['Sneakers hautes']->count() > 0)
                @foreach ($chaussuresPagineesParType['Sneakers hautes'] as $chaussure)
                            ...
                            <div class="p-4 bg-white shadow w-80">
                                <div class="flex justify-center relative rounded-lg overflow-hidden h-96 w-72">
                                    <div class="absolute inset-0 flex justify-center items-center">
                                        @if ($chaussure->image)
                                        <img src="{{ url('images/' . $chaussure->image->image_chaussure) }}" class="object-contain" alt="Image chaussure">
        ...
        @if ($chaussuresPagineesParType['Sneakers hautes']->count() > 0)
            <div class="col-span-12 flex justify-center py-4">
                {{ $chaussuresPagineesParType['Sneakers hautes']->links() }}
            </div>
        @endif
