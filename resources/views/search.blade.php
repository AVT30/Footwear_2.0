...
@section('content')
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg py-7">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 divide-y divide-gray-200 sm:table-auto sm:min-w-full sm:px-6">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                        <td class="w-32 p-4">
                            <a href="{{ route('chaussures.show', $chaussure->id_chaussure) }}" class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                                <img src="{{ asset('storage/images/'.$chaussure->image->image_chaussure) }}" alt="Apple Watch">
                            </a>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <a href="#" class="font-medium text-blue-700 dark:text-blue-900 hover:underline">Ajouter au panier</a>
                        </td>
                        @endforeach
                    </tr>
                </tbody>
