                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input
                                ...
                                placeholder="Entrez les valeurs par défault : John Smith" type="text" id="nomcarte"
                                name="nomcarte" maxlength="50" />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div>
                            <input
                                class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                                placeholder="4242 4242 4242 4242" type="number" id="number" name="number"
                    ...
                    <div class="mb-3 -mx-2 flex items-end">
                        <div class="px-2 w-1/2">
                            ...
                            <div>
                                <input type="number"
                                    class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                                    id="exp_month" name="exp_month" placeholder="12 " maxlength="2" required>
                            </div>
                        </div>
                        <div class="px-2 w-1/2">
                            <input type="number"
                                class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                                id="exp_year" name="exp_year" placeholder="2025" maxlength="4" required>
                        </div>
                    </div>
                    <div class="mb-10">
                        ...
                        <div>
                            <input
                                ...
                                placeholder="123" type="number" id="cvc" name="cvc" required />
                        </div>
                    </div>
                    <div class="mb-10">
                        <div>
                            <input hidden type="text" class="form-control" id="totalapayer" name="totalapayer"
                                {{ $totalpanier }}>
                        </div>
                    </div>
                    <div>
                        <button type="submit"
                            class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"><i
                                class="mdi mdi-lock-outline mr-1"></i> Payer {{ $totalpanier }} CHF</button>
                    </div>
                </form>
                    ...
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        ...
                        <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                            <svg class="fill-current h-6 w-6 text-red-500" role="button" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <title>Close</title>
                                <path
                                    d="M14.348 5.652a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414L15.586 10l-2.293-2.293a1 1 0 010-1.414l3-3z" />
                            </svg>
                        </span>
                    </div>
                @endif
