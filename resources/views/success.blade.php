    ...
    <div class="flex items-center justify-center py-10">
        <div>
            <div class="flex flex-col items-center space-y-2">
                ...
                <a href="/accueil"
                    class="flex items-center gap-2 px-4 py-2 font-medium text-white bg-blue-500 rounded hover:bg-blue-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
                            d="M10 2.05l8.87 8.68a1 1 0 01-.54 1.8l-.33.05H15v5a1 1 0 01-1 1H6a1 1 0 01-1-1v-5H2.99a1 1 0 01-.85-.48l-.05-.1a1 1 0 01.11-1.09l8.87-8.68a1.5 1.5 0 012.06 0z"
                            clip-rule="evenodd" />
                    </svg>
                    <span>Accueil</span>
                </a>
