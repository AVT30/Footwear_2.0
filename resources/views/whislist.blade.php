                            ...
                            <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                                ...
                                <div class="flex w-full flex-col px-4 py-4">
                                    ...
                                    <div class="flex space-x-2">
                                        <a class="inline-block text-sm text-red-600 align-baseline hover:text-red-900"
                                            href="{{ route('whislist.supprimerwhislist', $chaussure->id_chaussure) }}">Supprimer</a>
                                        <a class="inline-block text-sm text-blue-500 align-baseline hover:text-blue-800"
                                            href="./index.html">Ajouter au panier</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
